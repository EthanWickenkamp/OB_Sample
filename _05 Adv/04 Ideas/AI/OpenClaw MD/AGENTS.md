...
](https://docs.openclaw.ai/reference/templates/AGENTS#first-run)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#session-startup)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#memory)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#-write-it-down-no-%E2%80%9Cmental-notes%E2%80%9D)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#red-lines)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#external-vs-internal)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#group-chats)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#-know-when-to-speak)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#-react-like-a-human)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#tools)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#-heartbeats-be-proactive)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#heartbeat-vs-cron-when-to-use-each)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#-memory-maintenance-during-heartbeats)
...
](https://docs.openclaw.ai/reference/templates/AGENTS#make-it-yours)
