...
| `gemini extensions`                | Manage extensions                  | See [Extensions Management](Gemini%20CLI%20cheatsheet.md#extensions-management) |
| `gemini mcp`                       | Configure MCP servers              | See [MCP Server Management](Gemini%20CLI%20cheatsheet.md#mcp-server-management) |
...
| `--model`                        | `-m`  | string  | `auto`    | Model to use. See [Model Selection](Gemini%20CLI%20cheatsheet.md#model-selection) for available values.                                                                                            |
